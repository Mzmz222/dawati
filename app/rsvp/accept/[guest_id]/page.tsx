        ...
        return (
            <div className="min-h-screen flex items-center justify-center bg-zinc-50">
                <div className="text-center space-y-4">
                    ...
                    <p className="text-zinc-500">جاري تأكيد حضورك...</p>
                </div>
            </div>
        );
    }
            ...
            <div className="min-h-screen bg-zinc-50">
                ...
                <main className="max-w-md mx-auto px-6 pt-32 pb-20 text-center">
                    <div className="bg-white p-10 rounded-[2.5rem] shadow-lg border border-zinc-100 space-y-4">
                        ...
                        <h2 className="text-2xl font-bold text-red-600">عذراً</h2>
                        <p className="text-zinc-500">حدث خطأ أثناء تأكيد الحضور. الرجاء التواصل مع المنظم.</p>
            ...
            <main className="max-w-md mx-auto px-6 pt-32 pb-20 text-center">
                <div className="bg-white p-10 rounded-[2.5rem] shadow-xl border border-zinc-100 space-y-6 animate-scale-in">
                    ...
                    <div className="space-y-2">
                        <h2 className="text-3xl font-black text-primary font-headline">تم تأكيد حضورك!</h2>
                        <p className="text-zinc-500 font-body">
                            نتطلع لرؤيتك في حفل {guest?.events?.title || 'المناسبة'} بإذن الله
                        </p>
                    </div>
                    <div className="pt-4">
                        <p className="text-sm text-[#6A0DAD] font-bold">
                            {guest?.events?.date} - {guest?.events?.hall_name}
                        </p>
                    </div>
